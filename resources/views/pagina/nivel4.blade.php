...
<head>
	<meta charset="UTF-8">
	<title>{{$sub_actividad[0]->nombre}}</title>
...
<section>
	<div class="container ">
		<div class="col-12">
			<div class="bg-img-head" style="background-image: url({{ asset('foto_actividades/'.$foto_extendida[0]->foto) }});">
			</div>
		</div>
	</div>
</section>
...
<section class="container">
	<ol class="breadcrumb bg-white">
		...
		<li class="breadcrumb-item"><a href="{!!URL::to('quehacer')!!}">Qué hacer</a></li>
		<li class="breadcrumb-item"><a href="{{route('quehacern3',$sub_actividad[0]->actividad)}}">{{$sub_actividad[0]->actividad}}</a></li>
			...
			<div class="col-12 col-md-7">
				<div class="card-content">
					...
					<div>
						...
						content:'';left:1rem;top:3rem;margin:10px auto;width:25%;height:3px;background:#ed1a38">
					</div>
					<br>
					...
					<div class="content">
						<p>{{$sub_actividad[0]->descripcion}}.</p>
			...
			<div class="col-12 col-md-5 ">
				<div class="card-content">
					...
					<ul class="list-unstyled">
						...
						<li class="media my-3">
							<a href="{{ route('quehacern4',$in->nombre) }}">
