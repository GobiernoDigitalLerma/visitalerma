  ...
  <div class="container divfotoprincipal">
    <div class="col-12">
      <div class="bg-img-head">
        <img width="100%" height="auto" src="/public/foto_actividades/{{  $foto_extendida[0]->foto }}" width="100%" height="420px" class="principal">
...
<section class="container">
  <ol class="breadcrumb bg-white">
    ...
    <li class="breadcrumb-item"><a href="{!!URL::to('festival-cultura')!!}">Festivales y Cultura</a></li>
    <li class="breadcrumb-item"><a href="{{route('festival.actividades',$sub_actividad[0]->actividad)}}">{{$sub_actividad[0]->actividad}}</a></li>
      ...
      <div class="col-12 col-md-5 ">
        <div class="card-content">
          ...
          <ul class="list-unstyled">
            ...
            <li class="media my-3">
              <a href="{{ route('festival.actividades.detalle',$in->nombre) }}">
