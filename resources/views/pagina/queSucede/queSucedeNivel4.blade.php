...
<!--breadcumbs-->
    ...
    <li class="breadcrumb-item"><a href="{!!URL::to('queSucede')!!}">Qué sucede ahora</a></li>
    <li class="breadcrumb-item"><a href="{{route('pagina.queSucedeNivel3',$sub_actividad[0]->actividad)}}">{{$sub_actividad[0]->actividad}}</a></li>
...
<section class="events bg-light">
	<div class="container">
		<div class="row justify-content-between">
            ...
            <li class="media my-3">
              <a href="{{ route('pagina.queSucedeNivel4',$in->nombre) }}">
